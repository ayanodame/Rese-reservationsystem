...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'open_time' => '17:00',
            'close_time' => '22:00',
            'image_url' => 'https://rese-shoplist.s3.ap-northeast-1.amazonaws.com/sushi.jpg',
        ];
        ...
        $param = [
            ...
            'open_time' => '17:00',
            'close_time' => '22:00',
            'image_url' => 'https://rese-shoplist.s3.ap-northeast-1.amazonaws.com/yakiniku.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '戦慄',
            ...
            'open_time' => '17:00',
            'close_time' => '23:00',
            'image_url' => 'https://rese-shoplist.s3.ap-northeast-1.amazonaws.com/izakaya.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => 'ルーク',
            ...
            'open_time' => '17:00',
            'close_time' => '22:00',
            'image_url' => 'https://rese-shoplist.s3.ap-northeast-1.amazonaws.com/italian.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '志摩屋',
            ...
            'open_time' => '17:00',
            'close_time' => '21:00',
            'image_url' => 'https://rese-shoplist.s3.ap-northeast-1.amazonaws.com/ramen.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '香',
