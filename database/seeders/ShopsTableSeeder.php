...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'open_time' => '17:00',
            'close_time' => '22:00',
            'image_url' => 'https://lh3.googleusercontent.com/pw/AM-JKLVeY6hl85XgrPbR6hcGMvXiA47T1Jf5RK-NXPxtlby0_6FzbfBh9KECogdZah6nN8NcBxvo79hOUy5M6PoJ7-guJ1Zqq_aBmfzUv73qgdjXXw94W1ggihiU4wbp-GceNGXNBlC7uBpNIMN5DmmOaE7m=w991-h660-no?authuser=0',
        ];
        ...
        $param = [
            ...
            'open_time' => '17:00',
            'close_time' => '22:00',
            'image_url' => 'https://lh3.googleusercontent.com/pw/AM-JKLUdlTiZ7kABsEe6hrqN6OXTmPafRCnKqxszz6Ie3nfNmwzxtpGKxGXkJNLfFoyWgGDlXPivgb3xKFhNRxraPp6yx0ATnLB_JuRdlwMk47R6IblEdUlPC7k-7lS5zHm3PWIwvqj8lkm-QycomcFzepLd=w993-h660-no?authuser=0',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '戦慄',
            ...
            'open_time' => '17:00',
            'close_time' => '23:00',
            'image_url' => 'https://lh3.googleusercontent.com/pw/AM-JKLWXqy3uwxbXB0p6T2jiiqYVCTFuZFJ4Be5Sem9gOFSwWlbVBJeli02y_VUpJ0rwpT4NCrU0bl50R2mlIjDhY_YYZMsbDCzX-inOVRbDhnBLlzev4_GAocbWPS8kMihpdjI85QIHDIVt4Ft3gjR1VuLc=w993-h660-no?authuser=0',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => 'ルーク',
            ...
            'open_time' => '17:00',
            'close_time' => '22:00',
            'image_url' => 'https://lh3.googleusercontent.com/pw/AM-JKLVib0yveNm3k9b5xJJrpV21mF0_Ft4uD2215o6SXksz61yky5O7TB_-ysnkN6IMXdLfALEjKhl-jP2Ula6wy-T-0ed_O2LQbhwHUeZDNakAEKAOPLqqGoN9X-7zMckyD73QPoaBgWuxmq3GCwDvWATi=w991-h660-no?authuser=0',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '志摩屋',
            ...
            'open_time' => '17:00',
            'close_time' => '21:00',
            'image_url' => 'https://lh3.googleusercontent.com/pw/AM-JKLXrevz5kI3qk1AHDERKqiGtlRF-f83dI_C3XuO0bQySAr9lKdhXb-O9RDVi1vRd2Xh5TKi5PbSYwNgeqCaspJV6TrG_CfDK2pD47otsmtgST5j7NvudbToU-9GmA0ihqDV9AcYMXfx9bdfwk5MSuBFb=w991-h660-no?authuser=0',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '香',
